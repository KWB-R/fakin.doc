...
management especially designed for small reserach institutes.
...
In section [Data workflow](#data-workflow) of this chapter we propose to
distinguish between [raw data](#raw-data), processed data and project results.
