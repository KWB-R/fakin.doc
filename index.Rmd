...
- Quantitatives mikrobiologisches Risikomanagement
    ...
    + [kwb.qmra](https://github.com/kwb-r/kwb.qrma): wird im Rahmen von AQUANES(#aquanes)
    weiter genutzt
...
(Semi)automatisierte Erstellung eines komplexen MODFLOW Modells (mehre Layer, 
mehrere hunderte Entnahmenbrunnen mit zeitlicher UND räumlicher ) in Phyton 
mittels [flopy](http://modflowpy.github.io/flopydoc/) sowie Entwicklung der Modellszenarien auf Github (siehe hier: [Maxflow](https://github.com/chmenz/Maxflow)).
...
[Haridwar](http://aquanes-h2020.eu/Default.aspx?t=1668)) sowie deren Verknüpfung mit Labordaten
    ...
    + Herausforderungen: zeitlich hoch aufgelöste Betriebsdaten (~ 10 Mio. Daten-
    punkte pro Monat) erforderten massive Performance Optimierung um auch 
    Visualisierung der Rohdaten im Tool über den Testbetriebszeitraum auf Rechnern 
    mit limitierten RAM Ressourcen (~ 8 GB) zu ermöglichen
    
    + Nutzung: wird von den Projektpartnern zum struktiereten Datenimport genutzt 
    um dann darauf ggf. eigene weitere Analysen darauf aufzusetzen. Für die beiden 
    Berliner Standorte wird zudem die Visualiserung der Betriebsdaten routinenmäßig
    von genutzt, um von dem Normbetrieb abweichende Zustände leichter indentifizieren 
    zu können.
