...
- [Github](https://github.com): for developing/publishing program code, because it offers the opportunity to automatically get a
...
```{block2 type = "rmdtip"}
A [blog post](https://101innovations.wordpress.com/2016/10/09/github-and-more-sharing-data-code/)  @Bosman_2016 provide results of a large survey carried out in 
2015 among more than 15000 researchers. Insights can be gained on:   
