...
#### Regeln dafür, was wohin gehört

Was gehört in den Projektordner, was nicht?

**Software sollte nicht innerhalb der Projekte gespeichert werden**

Vorteil:

- Software wird ggf. projektübergreifend verwendet
- Software besteht oft aus vielen und großen Binärdateien und bläht den 
  Projektordner auf
- Software hat oft viele Unterverzeichnisse und erzeugt eine hohe 
  Verschachtelungstiefe im Projektordner

Nachteil:

- Es ist ggf. nicht klar, in welchem Projekt eine Software verwendet wurde
...
from the KWB intranet. However, this requires: 
    ...
    + the installation of the client software [TortoiseSVN](https://tortoisesvn.net/index.de.html)        and a
