...
* [what metadata](#metadata-what) (about raw data, processed data, produced 
plots, documents, reports, etc.) we want to store, 
...
* interpret raw data, e.g. "Why are the oxygen values so high? Ah, I see,
someone was there to clean the sensor!",
...
1. together with the data or near to the data i.e. in the same folder as the
data file is in
