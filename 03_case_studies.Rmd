...
solutions are tools which are based on the open software R. The free software 
approach allows any R programmer to produce customized tools for each individual 
end-user `to be added in manual.bib: (Gibert et al., 2015; Sonnenberg et al., 2014)`.
