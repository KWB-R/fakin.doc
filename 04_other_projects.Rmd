...
- Quantitative microbiological risk assessment: the R package [kwb.qmra](https://github.com/kwb-r/kwb.qrma) 
...
`r citep(manual[c("Krausetal_2016", "Rustler_2016")])`. A detailed documentation
