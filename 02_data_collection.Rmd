...
`r citep(manual["Grolemund_2017"])`

### Logger Devices

The R package [kwb.logger](https://github.com/kwb-r.kwb.logger) `r citep(manual["Sonnenberg_2018"])`
helps to import raw data from loggers used in different KWB projects into the 
software [R](https://r-project.org) `r citep(citation())`, which is used for 
