...
- [Case studies](#case-studies): tested in detail within FAKIN (i.e. proposed 
best-practices will be applied for this case studies and cross-checked whether 
their application is useful

- [Others](#other-projects): just suming up the data workflows and created tools 
for enlarging the KWB internal knowledge what has already been done.  
...
large raw data output files (> 300 MB csv files) that are sometimes are even 
to big for EXCEL 2010 (> 1 millions) and but need to be aggregated (e.g. grouped 
by specific criteria). This was usually performed manually within EXCEL.

**Workflow improvement developed within FAKIN:**

An open source R package [kwb.umberto](https://kwb-r.github.io/kwb.umberto) was 
programmed for automating: 
