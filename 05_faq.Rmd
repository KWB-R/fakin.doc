...
## Writing more robust R scripts

For details on making R scripts more robust to work on different computers
...
Regelmäßige Updates/Commits,

Bei Verwendung/Weiterbearbeitung von Code aus einem Projekt (z.B. OGRE) in 
...
## More ressources (to be put in the relevant chapters)

- [Einstieg ins Forschungsdatenmanagement in den Geowissenschaften](http://doi.org/10.2312/lis.14.01) 
...
- **Ten simple rules**
    ...
    + [for digital data storage](https://doi.org/10.1371/journal.pcbi.1005097) `r  
    citep("10.1371/journal.pcbi.1005097")`
  
    + [for making research software more   
    robust](https://doi.org/10.1371/journal.pcbi.1005412) `r 
    citep("10.1371/journal.pcbi.1005412")`
  
    + [to enable multi-site collaborations through data 
    sharing](https://doi.org/10.1371/journal.pcbi.1005278) `r 
    citep("10.1371/journal.pcbi.1005278")`
      
- [Handbuch Forschungsdatenmanagement](http://www.forschungsdatenmanagement.de/) 
`r citep(manual["Buettner_2011"])`
