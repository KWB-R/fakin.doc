...
format with this online validator: https://ci.appveyor.com/tools/validate-yaml
...
### Special Metadata Files {#file-projects}

Thie file `PROJECTS.yml`contains the [project acronyms](#project-acronyms) as we 
want to use them e.g. as top-level folder names in our 
